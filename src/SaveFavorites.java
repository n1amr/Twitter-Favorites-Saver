...
public class SaveFavorites {
      ...
      if (jsonTweet == null)
        ...
        try {
          if (!isChecked(id)) {
            ...
            // Save progress
            FileHelper.saveProgress(FileHelper.loadProgress().getInt("i"),
                FileHelper.loadProgress().getInt("page"), id, m, y);
        ...
        TweetsHelper.printTweet(jsonTweet);
        System.out.println("Skipped; This tweet has already been saved #"
  ...
  static void markDeleted(long id) throws IOException {
    File deletedIdsFile = new File(FileHelper.failedIdsFolder, "deleted.txt");
